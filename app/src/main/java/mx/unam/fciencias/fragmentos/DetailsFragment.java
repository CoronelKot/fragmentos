...
public class DetailsFragment extends Fragment {
    ...
    public static final String INDEX_KEY = "mx.unam.fciencias.fragmentos.INDEX";
    public static final String MASTER_LIST_SIZE_KEY = "mx.unam.fciencias.fragmentos.MASTER_LIST_SIZE_KEY";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args == null) {
            selectedIndex = -1;
            masterListSize = -1;
            Log.w(DetailsFragment.class.getSimpleName(),"Entrada invalida");
            return;
        }
